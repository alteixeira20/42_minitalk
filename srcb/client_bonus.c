...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/08 18:36:22 by paalexan          #+#    #+#             */
/*   Updated: 2025/03/08 19:55:51 by paalexan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	send_signal(int server_pid, unsigned char c)
{
	int	i;
...
static void	send_message(int server_pid, unsigned char *str)
{
	int					i;
